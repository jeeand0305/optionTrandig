...
#define __PYX_HAVE__bs_module
#define __PYX_HAVE_API__bs_module
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "bs_module" */
static double __pyx_f_9bs_module_std_norm_cdf(double); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "bs_module"
extern int __pyx_module_is_main_bs_module;
int __pyx_module_is_main_bs_module = 0;

/* Implementation of "bs_module" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9bs_module_calculate_black_scholes_cython(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S, double __pyx_v_K, double __pyx_v_r, double __pyx_v_sigma, double __pyx_v_T, PyObject *__pyx_v_option_type); /* proto */
...
#define __pyx_kp_u_bs_module_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_bs_module __pyx_string_tab[10]
#define __pyx_n_u_calculate_black_scholes_cython __pyx_string_tab[11]
#define __pyx_n_u_call __pyx_string_tab[12]
...
static double __pyx_f_9bs_module_std_norm_cdf(double __pyx_v_x) {
  double __pyx_r;
 ...
 * #  ,
*/
  __pyx_r = (0.5 * (1.0 + erf((__pyx_v_x / 1.4142135623730951))));
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_9bs_module_1calculate_black_scholes_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_9bs_module_1calculate_black_scholes_cython = {"calculate_black_scholes_cython", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9bs_module_1calculate_black_scholes_cython, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9bs_module_1calculate_black_scholes_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("calculate_black_scholes_cython (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_S,&__pyx_mstate_global->__pyx_n_u_K,&__pyx_mstate_global->__pyx_n_u_r,&__pyx_mstate_global->__pyx_n_u_sigma,&__pyx_mstate_global->__pyx_n_u_T,&__pyx_mstate_global->__pyx_n_u_option_type,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "calculate_black_scholes_cython", 0) < (0)) __PYX_ERR(0, 9, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 6; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("calculate_black_scholes_cython", 1, 6, 6, i); __PYX_ERR(0, 9, __pyx_L3_error) }
      }
    ...
    __pyx_v_S = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_S == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_K = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_K == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_r == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_sigma = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_sigma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_T = __Pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_T == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_option_type = ((PyObject*)values[5]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_black_scholes_cython", 1, 6, 6, __pyx_nargs); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("bs_module.calculate_black_scholes_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_option_type), (&PyUnicode_Type), 1, "option_type", 1))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_r = __pyx_pf_9bs_module_calculate_black_scholes_cython(__pyx_self, __pyx_v_S, __pyx_v_K, __pyx_v_r, __pyx_v_sigma, __pyx_v_T, __pyx_v_option_type);
...
static PyObject *__pyx_pf_9bs_module_calculate_black_scholes_cython(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S, double __pyx_v_K, double __pyx_v_r, double __pyx_v_sigma, double __pyx_v_T, PyObject *__pyx_v_option_type) {
  double __pyx_v_d1;
  double __pyx_v_d2;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calculate_black_scholes_cython", 0);
 ...
 *         else:
*/
    __pyx_t_2 = (__Pyx_PyUnicode_Equals(__pyx_v_option_type, __pyx_mstate_global->__pyx_n_u_Call, Py_EQ)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 11, __pyx_L1_error)
    if (!__pyx_t_2) {
    } else {
      __pyx_t_1 = __pyx_t_2;
...
*/
      ...
      __pyx_t_6 = PyFloat_FromDouble(__pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 12, __pyx_L1_error)
...
*/
    /*else*/ {
      ...
      __pyx_t_6 = PyFloat_FromDouble(__pyx_t_4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 14, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_r = __pyx_t_6;
      __pyx_t_6 = 0;
      goto __pyx_L0;
...
*/
  ...
  __pyx_t_4 = (log((__pyx_v_S / __pyx_v_K)) + ((__pyx_v_r + ((__pyx_v_sigma * __pyx_v_sigma) / 2.0)) * __pyx_v_T));
  __pyx_t_5 = (__pyx_v_sigma * sqrt(__pyx_v_T));
  if (unlikely(__pyx_t_5 == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 17, __pyx_L1_error)
  }
  __pyx_v_d1 = (__pyx_t_4 / __pyx_t_5);
 ...
 *     if option_type == 'Call' or option_type == 'call':
*/
  __pyx_v_d2 = (__pyx_v_d1 - (__pyx_v_sigma * sqrt(__pyx_v_T)));
 ...
 *     else:
*/
  __pyx_t_2 = (__Pyx_PyUnicode_Equals(__pyx_v_option_type, __pyx_mstate_global->__pyx_n_u_Call, Py_EQ)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 20, __pyx_L1_error)
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
...
*/
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_6 = PyFloat_FromDouble(((__pyx_v_S * __pyx_f_9bs_module_std_norm_cdf(__pyx_v_d1)) - ((__pyx_v_K * exp(((-__pyx_v_r) * __pyx_v_T))) * __pyx_f_9bs_module_std_norm_cdf(__pyx_v_d2)))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_r = __pyx_t_6;
    __pyx_t_6 = 0;
    goto __pyx_L0;
...
*/
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_6 = PyFloat_FromDouble((((__pyx_v_K * exp(((-__pyx_v_r) * __pyx_v_T))) * (1.0 - __pyx_f_9bs_module_std_norm_cdf(__pyx_v_d2))) - (__pyx_v_S * (1.0 - __pyx_f_9bs_module_std_norm_cdf(__pyx_v_d1))))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_r = __pyx_t_6;
    __pyx_t_6 = 0;
    goto __pyx_L0;
...
static int __pyx_pymod_exec_bs_module(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bs_module},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_bs_module(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bs_module(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bs_module(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bs_module' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "bs_module" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_bs_module", 0);
  ...
  if (__pyx_module_is_main_bs_module) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bs_module")) {
      if (unlikely((PyDict_SetItemString(modules, "bs_module", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *         if option_type == 'Call' or option_type == 'call':
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9bs_module_1calculate_black_scholes_cython, 0, __pyx_mstate_global->__pyx_n_u_calculate_black_scholes_cython, NULL, __pyx_mstate_global->__pyx_n_u_bs_module, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_calculate_black_scholes_cython, __pyx_t_2) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init bs_module", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init bs_module");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{13},{4},{1},{20},{1},{1},{18},{9},{30},{4},{18},{2},{2},{8},{13},{5},{8},{10},{8},{11},{3},{12},{1},{12},{10},{5},{8},{6},{221}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (589 bytes) */
const char* const cstring = "BZh91AY&SY\313]\302\312\000\0001\377\377\377\314\277\200_\203<D\277-~\000\277\377\377d@@@@@@@@@@@@@\000@\000@\001\245F05OP\003E=1\t\246\236Q\221\2404dh\000\001\211\247\244\364\324\364i\265\036\2505\032\023@\r55\036\214S\322\000\000\000\000\000\r\000m 51\r#T\375P\362\215\036\247\250\320\320\000\000\032\032\000\000\000\000sF\215\r0\200i\2014\320\006CC\020\006\214F\206\010\310\002\375BY\304\340\263\321F\255d\263hx*\261@I\256\323K\006\316\014v\006\240f\252\354\2060\350\232\354\335\0314^V\205\030\221S\2524\270\342\211\256\273u\305\210+\004\324\226\362x\214g\211\312\245d'\341\333^%\244r\264\304f\006Z\304\265t5C\351\354\356n\265 <\365'\375\247\370\\\220\206\003z\316x\003\355#y\034Z\216\177\245m\252r\270S\2315\202\351\220L)\276\242T\222FH\216\324t]U\351J\354\332\314\2256\357\317\020\272\242\221\266Y\233\227vQn:/K\224\035\027\332\341\353Y\020\2441\372a\016\204\246Ha\321\201u\340\2629\346\033\006\241\025\\`\276d\305a&\234R\271\212BQ,Ca^\210\"\007UR\215k0\306)v\252\237\001\247\020\341\232(\325D\013@\225\342\r\241\311\022u\005\264\203\350|\2153\212H\022\270\333\271:0\270\211\251\003V\030t\317\203v \262&\035\372\335\206\326\307\324\020\025/\275\020\250\243`Jte\tjj\255d\344+\251:\"\223\216=\2410\312X-\223\030\r<@WU\274I\0040\230\366\260\316\212\0214\352\231)\"q\024\235\031\300\260%\206+\202\274,QQ\245\255\037\325\017\201\233I7\310\310\204\032\246\007\304\016vl?]+\365*\257\021\231\304-c\223 PH\202\227O\361m\322\240\335\363\206l\301\373\2038\301\251#Y\341\007u\327}]w-\201K\244P\270\032g-(\250\301\321\030<m\"8\336\314\364P!\310MY\304C\207\031\\\346\220!\366\255\376\024K\017\361w$S\205\t\014\265\334,\240";
